...
export function InputBar({ onSend, disabled, branch }: InputBarProps) {
  ...
  return (
    <div className="border-t border-slate-800/60 bg-ink-950/80 px-5 pb-5 pt-3 backdrop-blur-md">
      {/* Suggested chips row */}
      <div className="mx-auto mb-3 flex max-w-3xl flex-wrap items-center gap-1.5">
      ...
      <div className="mx-auto max-w-3xl">
        <div className="flex items-center gap-0 rounded-xl border border-slate-800/90 bg-slate-900/90 transition-colors focus-within:border-brand-500/30">
          ...
          <textarea
            ...
            className="flex-1 resize-none bg-transparent px-3 py-3 text-sm leading-6 text-slate-100 placeholder:text-slate-500 focus:outline-none disabled:opacity-50"
